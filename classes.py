...
class RandomPlayingCard:
    ...
    def __init__(self,
        ...
        self.joker_image_path = "venv/images/joker2.png"
        self.joker_jack_image_path = "venv/images/Jack_The_Joker.png"
        self.card_suits_image_path = "venv/images/card_suits.png"
        self.developer_mugshot = "venv/images/BK.png"
        self.developer_mugshot_inv = "venv/images/BK_Inv.png"
