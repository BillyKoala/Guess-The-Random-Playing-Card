...
def main():
    ...
    globals.joker_image_path = rpc.joker_image_path
    globals.joker_jack_image_path = rpc.joker_jack_image_path
    card_suits_image_path = rpc.card_suits_image_path
    globals.developer_mugshot = rpc.developer_mugshot
    globals.developer_mugshot_inv = rpc.developer_mugshot_inv
