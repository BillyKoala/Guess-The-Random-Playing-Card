...
def main():
    ...
    globals.info_label_dict = {"before":"Getting Cards Ready...",
    ...
    try:
        ...
        welcome_info_label = Label(matrix_info_frame, text=globals.info_label_dict.get("header"),
        relief="raised", font=("Arial Black", 11), bg="#1753b3", fg="#b0b317")
        welcome_info_label.pack(padx=125)

        # Add an updatable banner.
        hint_info_label = Label(matrix_info_frame, text=globals.info_label_dict.get("before"),
        ...
        # Add a status bar.
        status_bar = Label(root, width=99, height=1, relief="sunken")
        status_bar.place(x=0, y=532)
